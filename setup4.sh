#!/bin/bash
# setup4.sh - Vue planning Gantt dédiée
# Lance depuis la racine du projet : bash setup4.sh

echo "📦 Création page planning..."

mkdir -p app/planning

cat > app/planning/page.tsx << 'ENDOFFILE'
...
cat > app/planning/PlanningClient.tsx << 'ENDOFFILE'
'use client'
...
echo "✅ Page planning créée !"
echo ""
echo "Lance maintenant :"
echo "  git add ."
echo "  git commit -m 'feat: vue planning Gantt'"
echo "  git push"
